...
{  
    ...
    {
        #if UNITY_EDITOR
        public static string missingCharacters = "";
        #endif
                                ...
                                else
                                {
                                    ...
                                    if (tempFontAsset != null && tempFontAsset.characterDictionary.TryGetValue(altGlyphCode, out glyph))
                                    {
                                        ...
                                        if (!TMP_Settings.warningsDisabled) {
                                          Debug.LogWarning("Character:" + (char)c + " with ASCII value of " + c + " was not found in the Font Asset Glyph Table.", this);
                                          #if UNITY_EDITOR
                                          if(!missingCharacters.Contains(((char)c).ToString())){
                                            missingCharacters += (char)c;
                                          }
                                          #endif
                                        }
