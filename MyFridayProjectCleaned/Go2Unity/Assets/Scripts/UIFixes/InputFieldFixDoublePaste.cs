...
namespace UnityEngine.UI
{
  ...
  public class InputFieldFixDoublePaste
    : Selectable,
  ...
  ICanvasElement
  {
    ...
    protected InputFieldFixDoublePaste()
    {}
    ...
    public bool shouldHideMobileInput
    {
      set
      {
        wwUtility.SetStruct(ref m_HideMobileInput, value);
      }
      get
      {
    ...
    public float caretBlinkRate
    {
      ...
      set
      {
        if (wwUtility.SetStruct(ref m_CaretBlinkRate, value))
        {
          if (m_AllowInput)
            SetCaretActive();
        }
    ...
    public int caretWidth { get { return m_CaretWidth; } set { if (wwUtility.SetStruct(ref m_CaretWidth, value)) MarkGeometryAsDirty(); } }

    public Text textComponent { get { return m_TextComponent; } set { wwUtility.SetClass(ref m_TextComponent, value); } }

    public Graphic placeholder { get { return m_Placeholder; } set { wwUtility.SetClass(ref m_Placeholder, value); } }

    public Color caretColor { get { return customCaretColor ? m_CaretColor : textComponent.color; } set { if (wwUtility.SetColor(ref m_CaretColor, value)) MarkGeometryAsDirty(); } }
    ...
    public Color selectionColor { get { return m_SelectionColor; } set { if (wwUtility.SetColor(ref m_SelectionColor, value)) MarkGeometryAsDirty(); } }

    public SubmitEvent onEndEdit { get { return m_OnEndEdit; } set { wwUtility.SetClass(ref m_OnEndEdit, value); } }

    [Obsolete("onValueChange has been renamed to onValueChanged")]
    public OnChangeEvent onValueChange { get { return onValueChanged; } set { onValueChanged = value; } }

    public OnChangeEvent onValueChanged { get { return m_OnValueChanged; } set { wwUtility.SetClass(ref m_OnValueChanged, value); } }

    public OnValidateInput onValidateInput { get { return m_OnValidateInput; } set { wwUtility.SetClass(ref m_OnValidateInput, value); } }

    public int characterLimit { get { return m_CharacterLimit; } set { if (wwUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value))) UpdateLabel(); } }

    // Content Type related

    public ContentType contentType { get { return m_ContentType; } set { if (wwUtility.SetStruct(ref m_ContentType, value)) EnforceContentType(); } }

    public InputField.LineType lineType { get { return m_LineType; } set { if (wwUtility.SetStruct(ref m_LineType, value)) SetToCustomIfContentTypeIsNot(ContentType.Standard, ContentType.Autocorrected); } }

    public InputType inputType { get { return m_InputType; } set { if (wwUtility.SetStruct(ref m_InputType, value)) SetToCustom(); } }

    public TouchScreenKeyboardType keyboardType { get { return m_KeyboardType; } set { if (wwUtility.SetStruct(ref m_KeyboardType, value)) SetToCustom(); } }

    public CharacterValidation characterValidation { get { return m_CharacterValidation; } set { if (wwUtility.SetStruct(ref m_CharacterValidation, value)) SetToCustom(); } }
    ...
    public char asteriskChar { get { return m_AsteriskChar; } set { if (wwUtility.SetStruct(ref m_AsteriskChar, value)) UpdateLabel(); } }
    ...
    private bool m_pastedThisLoop = false;
    public virtual void OnUpdateSelected(BaseEventData eventData)
    {
      if (!isFocused)
        return;
      m_pastedThisLoop = false;
