...
{
    [CustomEditor(typeof(TouchScrollRect), true)]
    [CanEditMultipleObjects]
  public class TouchScrollRectEditor : Editor
    {
        ...
        SerializedProperty _zoomObject;
        SerializedProperty _zoomArea;
        SerializedProperty _fingerOnCtrlObject;
        SerializedProperty _zoomMax;
        SerializedProperty _zoomMin;
        ...
        protected virtual void OnEnable()
        {
            ...
            _zoomObject = serializedObject.FindProperty("_zoomObject");
            _zoomArea = serializedObject.FindProperty("_zoomArea");
            _fingerOnCtrlObject = serializedObject.FindProperty("_fingerOnCtrlObject");
            _zoomMax = serializedObject.FindProperty("_zoomMax");
            _zoomMin = serializedObject.FindProperty("_zoomMin");
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((TouchScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_zoomObject);
            EditorGUILayout.PropertyField(_zoomArea);
            EditorGUILayout.PropertyField(_fingerOnCtrlObject);
            EditorGUILayout.PropertyField(_zoomMax);
            EditorGUILayout.PropertyField(_zoomMin);
