...
@property (nonatomic, weak) id<PIRobotDFUTargetAdapterDelegate> dfuDelegate;
...
#pragma dfu
- (void) dfuSendNotificationRequest:(int) interval;
- (void) dfuSendStartCommand:(int) firmwareLength;
- (void) dfuSendReceiveCommand;
- (void) dfuSendFirmwareData:(NSData *) data;
- (void) dfuSendValidateCommand;
- (void) dfuSendResetAndActivate:(BOOL)activate;
@end
...
@protocol PIRobotDFUTargetAdapterDelegate <NSObject>
