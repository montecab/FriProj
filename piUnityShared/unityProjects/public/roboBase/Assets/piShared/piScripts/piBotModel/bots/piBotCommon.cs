...
public class piBotCommon : piBotBase {
	...
	public piBotComponentSoundSensor   SoundSensor  { get{ return (piBotComponentSoundSensor  )(components[ComponentID.COMPONENT_SOUND_SENSOR     ]); }}
	...
	protected override void setupComponents() {
		...
		addComponent<piBotComponentSoundSensor  >(PI.ComponentID.COMPONENT_SOUND_SENSOR     );
	}
