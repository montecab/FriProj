...
//#if UNITY_IPHONE
	...
	[DllImport("__Internal")]
	private static extern void mlogEventWithParametersTimed(string eventId, string parameters, bool timed);
	...
	public void logEvent(string eventId, Dictionary<string, string> parameters, bool timed=false)
	{
		...
		mlogEventWithParametersTimed(eventId,strParams, timed);
